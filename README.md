...
```yaml
uses: rmkr-dev/gha-reusable-workflows/.github/workflows/<name>.yml@v0.5.0
```
...
SBOM deep-dive: [docs/references/sbom.md](docs/references/sbom.md).
...
Workflows pin these with `rmkr-dev/gha-reusable-workflows/.github/actions/<name>@v0.5.0`.
