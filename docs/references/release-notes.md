...
```markdown
[Unreleased]: https://github.com/rmkr-dev/gha-reusable-workflows/compare/v0.5.2...HEAD
...
5. Bump consumer pin docs from `@v0.5.1` → `@v0.5.2` (then composites after the tag exists).
